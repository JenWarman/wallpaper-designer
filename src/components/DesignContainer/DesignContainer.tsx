...
export function DesignContainer() {
  ...
  return (
    ...
    >
      <div
        className={`${styles.designContainer__tile} ${
          direction === "left" ? styles.isActive : styles.isHidden
        }`}
      >
        <DesignTile />
        <img
      ...
      <div
        className={`${styles.designContainer__demo} ${
          direction === "right" ? styles.isActive : styles.isHidden
        }`}
      >
        <img
